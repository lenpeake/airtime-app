      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <View style={styles.card}>
            ...
            <TextInput style={styles.input} placeholder={t('createAccount.firstName')} value={firstName} onChangeText={setFirstName} placeholderTextColor="#9ca3af" />
            <Text style={styles.label}>{t('createAccount.lastName')}</Text>
            <TextInput style={styles.input} placeholder={t('createAccount.lastName')} value={lastName} onChangeText={setLastName} placeholderTextColor="#9ca3af" />
            <Text style={styles.label}>{t('createAccount.preferredName')}</Text>
            <TextInput style={styles.input} placeholder={t('createAccount.preferredName')} value={preferredNameInput} onChangeText={setPreferredNameInput} placeholderTextColor="#9ca3af" />
            <Text style={styles.label}>{t('createAccount.zipcode')}</Text>
            <TextInput style={styles.input} placeholder={t('createAccount.zipcode')} value={zipcode} onChangeText={setZipcode} keyboardType="number-pad" placeholderTextColor="#9ca3af" />
            <Text style={styles.label}>{t('createAccount.email')}</Text>
            <TextInput style={styles.input} placeholder={t('createAccount.email')} value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" placeholderTextColor="#9ca3af" />
            <Text style={styles.label}>{t('createAccount.password')}</Text>
            <TextInput style={styles.input} placeholder={t('createAccount.password')} value={password} onChangeText={setPassword} secureTextEntry placeholderTextColor="#9ca3af" />
